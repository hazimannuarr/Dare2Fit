Public Class frm_insertstaff_a167556
    ...
    Private Function generate_matric() As String
        ...
        Dim lastmatric As String = run_sql_query("SELECT MAX(FLD_STAFF_ID) AS LASTMATRIC FROM TBL_STAFF_A167556").Rows(0).Item("LASTMATRIC")
    ...
    Private Sub btn_insert_Click_1(sender As Object, e As EventArgs) Handles btn_insert.Click
        Dim mysql As String = "INSERT INTO TBL_STAFF_A167556 VALUES ('” & Text_id.Text & "', '" & Text_name.Text & "', '" & Text_phone.Text & "', '" & Text_email.Text & "')"
    ...
    Private Sub btn__Click_1(sender As Object, e As EventArgs) Handles btn_.Click
        frm_staff_a167556.Show()
        Me.Hide()
    End Sub

    Private Sub btn_picture_Click_1(sender As Object, e As EventArgs) Handles btn_picture.Click
