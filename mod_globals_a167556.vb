Module mod_globals_a167556

    Public myconnection As String = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=DB_DARE2FIT_A167556.accdb;Persist Security Info=False;"
