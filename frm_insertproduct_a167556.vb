Public Class frm_insertproduct_a167556

    Dim defaultpicture As String = Application.StartupPath & "\pictures\nophoto.jpg"

    Private Sub frm_insertproduct_a167556_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btn_insert_Click(sender As Object, e As EventArgs) Handles btn_insert.Click
        ...
        Dim mysql As String = "INSERT INTO TBL_PRODUCTS_A167556 VALUES ('” & Text_id.Text & "', '" & Text_name.Text & "', " & Text_price.Text & ", '" & Text_type.Text & "', '" & Text_material.Text & "', '" & Text_from.Text & "', '" & Text_shipping.Text & "')"
        ...
        Try
            ...
            Beep()
            MsgBox("Your item has been successfully inserted")
            clear_fields()
    ...
    Private Function generate_matric() As String
        ...
        Dim lastmatric As String = run_sql_query("SELECT MAX(FLD_PRODUCT_ID) AS LASTMATRIC FROM TBL_PRODUCTS_A167556").Rows(0).Item("LASTMATRIC")
